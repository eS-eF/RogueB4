...
### RNDラッパー
class RND_CuriosityWrapper(VecEnvWrapper):
    """
    ...
    def step_wait(self):
        ...
        reward = np.array(extrinsic_reward + self.intrinsic_reward_weight * intirinsic_reward)
        ...
        if self.training and self.steps > self.learning_starts and self.steps - self.last_update > self.train_freq:
            ...
            self.learn()
            print('EX : ', extrinsic_reward, 'INT : ',self.intrinsic_reward_weight*intirinsic_reward)
